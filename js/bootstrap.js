...
x.addListener(myFunction) // Attach listener function on state changes
  ...
  /*
  =======================================================================
       Navigation Sticky Script Library
  =======================================================================
  */
  $(window).scroll(function() {
      var scroll = $(window).scrollTop();
      var nav_outer = $(".nav-outer");
      if (scroll >= 3) {
          nav_outer.removeClass('affix-top').addClass("affix th-bg");
      } else {
          nav_outer.removeClass("affix th-bg").addClass('affix-top');
      }
  });